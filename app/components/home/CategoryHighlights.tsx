  ...
  return (
    <section className="w-full">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:hidden gap-4 col-span-2 sm:col-span-4">
        ...
        <div className="hidden lg:grid lg:grid-cols-6 gap-4 col-span-2 sm:col-span-4 lg:col-span-6">
