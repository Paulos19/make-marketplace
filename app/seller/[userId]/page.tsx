...
// Interface SellerProfile Atualizada
interface SellerProfile {
  id: string;
  name?: string | null;               // Nome pessoal do vendedor
  image?: string | null;              // Avatar
  whatsappLink?: string | null;
  storeName?: string | null;          // << NOVO
  profileDescription?: string | null;
  sellerBannerImageUrl?: string | null; // << NOVO
...
// ProductCard (pode ser o mesmo do AchadinhosDoZacaBanner ou um específico)
